# IPv4 PIM-SM 与 IGMP 组播

## 实验目标

OSPF 提供单播 RPF 路由，三台路由器运行 FRRouting `pimd`，并使用 `10.255.0.2`
作为静态 RP。两个接收端分别通过 IGMP 加入 `239.1.1.1`，观察 r3 将来自 source 的
一份 UDP 流复制到两个下游接口。
...
[查看 nslab.yaml](https://github.com/calcky/nslab/blob/main/examples/pim/nslab.yaml) ·
[查看示例 README](https://github.com/calcky/nslab/blob/main/examples/pim/README.md)
